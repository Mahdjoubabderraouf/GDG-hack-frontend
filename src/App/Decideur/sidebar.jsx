          ...
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton
                  asChild
                  onClick={() => handleClick("evaluation")} // Set active item on click
                  className={`gap-3 rounded-lg px-2 hover:bg-gray-100 font-bold text-black ${
                    activeItem === "Evaluation" ? "bg-first hover:bg-first" : ""
                  }`}
                >
                  <button>
                ...
                <SidebarMenuButton
                  asChild
                  onClick={() => handleClick()} // Set active item on click
                  className={`gap-3 rounded-lg px-2 hover:bg-gray-100 font-bold text-black ${
                    activeItem === "Graph" ? "bg-first hover:bg-first" : ""
                  }`}
                >
                  <a href="http://127.0.0.1:5500/graphe/index.html">
